...
class DialogUpdateMembers extends HookConsumerWidget {
  const DialogUpdateMembers(this.teamId, {super.key});
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                TeamDialogMember(
                  width: width - 48,
                  walletAddresses: ref.watch(updateMemberWalletAddressProvider),
                  onEdited: (wa) {
                    ref
                        .read(updateMemberWalletAddressProvider.notifier)
                        .update((state) => {...state, wa});
                  },
                  onDelete: (wa) {
                    ref.read(updateMemberWalletAddressProvider.notifier).update(
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // チームメンバーを追加
                  ref.read(teamInfoUseCaseProvider).addTeamMember(teamId!);
