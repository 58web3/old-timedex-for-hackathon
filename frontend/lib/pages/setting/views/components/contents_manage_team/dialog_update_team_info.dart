...
class DialogUpdateTeamInfo extends HookConsumerWidget {
  const DialogUpdateTeamInfo(this.teamId, {super.key});
            ...
            child: Column(
              children: [
                ...
                TeamDialogName(
                  ...
                  onEdited: (text) {
                    ref
                        .read(updateNameWalletAddressProvider.notifier)
                        .update((state) => text);
                  },
                ),
                Container(height: 12),
                TeamDialogDescription(
                  ...
                  onEdited: (text) {
                    ref
                        .read(updateDescriptionWalletAddressProvider.notifier)
                        .update((state) => text);
                  },
                ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: ElevatedButton(
                onPressed: () {
                  // チームの情報を更新
                  ref.read(teamInfoUseCaseProvider).updateTeamInfo(teamId!);
