...
class Team {
  ...
  @override
  String toString() => 'Team[teamId=$teamId, teamName=$teamName, teamDescription=$teamDescription, teamMembers=$teamMembers, createdAt=$createdAt, createdBy=$createdBy, updatedAt=$updatedAt, updatedBy=$updatedBy, deleteFlg=$deleteFlg]';
  ...
  static Team? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Team(
        ...
        teamMembers: json[r'team_members'] is List
            ? (json[r'team_members'] as List).cast<String>()
            : const [],
