...
class CommonResponse {
  ...
  int get hashCode =>
    ...
    (idInfo == null ? 0 : idInfo!.hashCode);

  @override
  String toString() => 'CommonResponse[message=$message, idInfo=$idInfo]';
  ...
  static CommonResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CommonResponse(
        ...
        idInfo: mapValueOfType<KeyValue>(json, r'id_info'),
      );
    }
    return null;
  }
