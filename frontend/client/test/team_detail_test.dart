...
// tests for TeamDetail
void main() {
  // final instance = TeamDetail();

  group('test TeamDetail', () {
    // String teamId
    ...
    test('to test the property `teamDescription`', () async {
      // TODO
    });

    // List<TeamMember> teamMembers (default value: const [])
    ...
    // bool deleteFlg
    test('to test the property `deleteFlg`', () async {
      // TODO
    });
